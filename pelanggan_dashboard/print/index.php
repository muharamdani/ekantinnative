<?php
    ...
    $query=mysqli_query($conn, "SELECT *FROM pelanggan WHERE username='$nama'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <?php while($result=mysqli_fetch_assoc($query)): ?>
        ...
        <tr>
            ...
            <td>
                <img style="padding-left:15px; padding-right:15px;" width=110px height=110px src="../../admin_dashboard/buat_user/generate/<?php echo $result['qrname']; ?>"></td>
            </tr>
        <tr>
