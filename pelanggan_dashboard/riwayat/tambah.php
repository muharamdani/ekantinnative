<?php
  ...
  //$query=mysqli_query($conn, "SELECT id, nis, first_name, last_name, penjual, saldo, waktu FROM transaksi where username='$username3' LIMIT $awaldata, $jumlahdataperhalaman");
  $query=mysqli_query($conn, "SELECT id, first_name, last_name ,add_saldo, waktu FROM log_saldo where pelanggan='$username3' ORDER BY id DESC LIMIT $awaldata, $jumlahdataperhalaman");
