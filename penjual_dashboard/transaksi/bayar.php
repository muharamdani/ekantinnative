          ...
          <form class="col s12" action="" method="POST">
            <div class="row">
              <div class="input-field col s12">
                <center><video id="preview" width=240></video></center>
                <script src="js/instascan.js"></script>
                <input type="number" name="nis" id=qrdata maxlength="200" placeholder="nis" autofocus />
              </div>
            </div>
            <div class="center-align"><input class="btn btn-success" type="submit" name=sendnis id=sendnis value="Submit" /></div>
            <?php sendnis(); ?>
            <br>
            <div class="center-align"><input class="btn btn-success" type="submit" name=tunai value="Tunai" /></div>
            <?php tunai(); ?>
          </form>
        </div>
      </div>
