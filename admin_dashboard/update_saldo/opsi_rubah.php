...
<html>
  ...
  <body>
    ...
    <section class="content">
      ...
      <div class="page-announce valign-wrapper"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">Tambah Saldo</h1></div>
      <div id="posttable" class="container">
      <div class="row">
      <h3 align=center>Pelanggan</h3>
        <div class="col l4 offset-l4 s12 tooltipped center" data-position="top" data-delay="50" data-tooltip="Data pelanggan"><a class="waves-effect waves-light btn-large" href="rubah_pelanggan.php">Pelanggan</a></div>
        <!-- <div class="col l4 s12 tooltipped" data-position="top" data-delay="50" data-tooltip="Data penjual"><a class="waves-effect waves-light btn-large" href="rubah_penjual.php">Penjual</a></div> -->
      </div>
      </div>
      </div>
    </div>
