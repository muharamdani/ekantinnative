...
<html>
  ...
  <body>
    ...
    <section class="content">
      <div class="page-announce valign-wrapper"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">Buat akun baru untuk..</h1></div>
        <div id="posttable" class="container">
          <div class="container">
            <div class="quick-links center-align">
              <h3>Pelanggan / Penjual</h3>
              <div class="row">
                <div class="col l4 offset-l2 s12 tooltipped" data-position="top" data-delay="50" data-tooltip="Pelanggan"><a class="waves-effect waves-light btn-large" href="buat_pelanggan.php">Pelanggan</a></div>
                <div class="col l4 s12 tooltipped" data-position="top" data-delay="50" data-tooltip="Penjual"><a class="waves-effect waves-light btn-large" href="buat_penjual.php">Penjual</a></div>
                <!-- <div class="col l4 offset-l3 s12 tooltipped" data-position="top" data-delay="50" data-tooltip="Data Pelanggan"><a class="waves-effect waves-light btn-large" href="update_user/rubah_penjual.php">Pelanggan</a></div>
                <div class="col l4 s12 tooltipped" data-position="top" data-delay="50" data-tooltip="Data Penjual"><a class="waves-effect waves-light btn-large" href="buat_penjual.php">Penjual</a></div> -->
              </div>
            </div>
          </div>
        </div>
