<?php
    ...
    $query=mysqli_query($conn, "SELECT *FROM user where id LIKE '%$keywords%' OR username LIKE '%$keywords%' OR level LIKE '%$keywords%' ORDER by level ASC LIMIT $awaldata, $jumlahdataperhalaman");
?>
...
<tr>
    ...
    <div class="btn-toolbar">
        ...
        <a href="delete_user/delete_penjual.php?id=<?php echo $result['id']; ?>" onclick="return confirm('Yakin Hapus Data?')">
