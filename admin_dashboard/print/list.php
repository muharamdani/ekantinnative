...
<html>
  <head>
    ...
    <script src="../files/live_print.js"></script>
  ...
  <body>
    ...
    <section class="content">
      ...
      <div class="page-announce valign-wrapper"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">Print Kartu Pelanggan</h1></div>
